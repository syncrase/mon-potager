...
public class Plante implements Serializable {
    ...
    public Plante references(Set<Reference> references) {
        this.setReferences(references);
        return this;
    }

    public Plante addReferences(Reference reference) {
        this.references.add(reference);
        reference.getPlantes().add(this);
        return this;
    }

    public Plante removeReferences(Reference reference) {
        this.references.remove(reference);
        reference.getPlantes().remove(this);
        return this;
    }
