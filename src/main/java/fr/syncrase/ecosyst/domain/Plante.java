...
public class Plante implements Serializable {
    ...
    /**
     * Le nom latin d'une plante est la composition du genre et de l'espèce. De ce fait une plante est associée au minimum avec une espèce (ou tout autre rang entre l'epsèce et le sous-genre)
     */
    @Schema(
        description = "Le nom latin d'une plante est la composition du genre et de l'espèce. De ce fait une plante est associée au minimum avec une espèce (ou tout autre rang entre l'epsèce et le sous-genre)"
    )
    @ManyToOne
