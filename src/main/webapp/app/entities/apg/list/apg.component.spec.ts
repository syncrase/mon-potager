...
describe('APG Management Component', () => {
  let comp: APGComponent;
  let fixture: ComponentFixture<APGComponent>;
  let service: APGService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'apg', component: APGComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.aPGS?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
