...
export class CronquistRankUpdateComponent implements OnInit {
  ...
  protected updateForm(cronquistRank: ICronquistRank): void {
    ...
    this.plantesSharedCollection = this.planteService.addPlanteToCollectionIfMissing(this.plantesSharedCollection, cronquistRank.plante);
  }
