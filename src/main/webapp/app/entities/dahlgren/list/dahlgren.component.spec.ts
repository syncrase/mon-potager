...
describe('Dahlgren Management Component', () => {
  let comp: DahlgrenComponent;
  let fixture: ComponentFixture<DahlgrenComponent>;
  let service: DahlgrenService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'dahlgren', component: DahlgrenComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(DahlgrenComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.dahlgrens?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
