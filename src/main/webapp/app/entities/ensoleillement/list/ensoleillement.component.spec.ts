...
describe('Ensoleillement Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ensoleillement', component: EnsoleillementComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ensoleillements?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
