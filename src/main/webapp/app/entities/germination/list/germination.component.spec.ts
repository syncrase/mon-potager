...
describe('Germination Management Component', () => {
  let comp: GerminationComponent;
  let fixture: ComponentFixture<GerminationComponent>;
  let service: GerminationService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'germination', component: GerminationComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(GerminationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.germinations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
