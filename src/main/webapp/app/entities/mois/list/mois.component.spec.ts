...
describe('Mois Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'mois', component: MoisComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.mois?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
