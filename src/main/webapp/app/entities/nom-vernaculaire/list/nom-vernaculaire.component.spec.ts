...
describe('NomVernaculaire Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'nom-vernaculaire', component: NomVernaculaireComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.nomVernaculaires?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
