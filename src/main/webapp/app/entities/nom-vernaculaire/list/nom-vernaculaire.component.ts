...
@Component({
  selector: 'jhi-nom-vernaculaire',
  templateUrl: './nom-vernaculaire.component.html',
})
export class NomVernaculaireComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.nomVernaculaireService
      ...
      .subscribe({
        next: (res: HttpResponse<INomVernaculaire[]>) => {
  ...
  trackId(_index: number, item: INomVernaculaire): number {
    return item.id!;
  }
