...
describe('Racine Management Component', () => {
  let comp: RacineComponent;
  let fixture: ComponentFixture<RacineComponent>;
  let service: RacineService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'racine', component: RacineComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(RacineComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.racines?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
