...
export class ReferenceComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.referenceService
      ...
      .subscribe({
        next: (res: HttpResponse<IReference[]>) => {
  ...
  trackId(_index: number, item: IReference): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IReference[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
