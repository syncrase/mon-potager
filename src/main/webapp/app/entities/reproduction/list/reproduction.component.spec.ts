...
describe('Reproduction Management Component', () => {
  let comp: ReproductionComponent;
  let fixture: ComponentFixture<ReproductionComponent>;
  let service: ReproductionService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'reproduction', component: ReproductionComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ReproductionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.reproductions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
