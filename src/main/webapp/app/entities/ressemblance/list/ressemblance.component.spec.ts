...
describe('Ressemblance Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ressemblance', component: RessemblanceComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ressemblances?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
