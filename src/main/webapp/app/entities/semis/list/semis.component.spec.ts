...
describe('Semis Management Component', () => {
  let comp: SemisComponent;
  let fixture: ComponentFixture<SemisComponent>;
  let service: SemisService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'semis', component: SemisComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SemisComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.semis?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
