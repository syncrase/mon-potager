...
describe('Sol Management Component', () => {
  let comp: SolComponent;
  let fixture: ComponentFixture<SolComponent>;
  let service: SolService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'sol', component: SolComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sols?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
