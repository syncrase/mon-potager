...
describe('Strate Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'strate', component: StrateComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.strates?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
