...
describe('Temperature Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'temperature', component: TemperatureComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.temperatures?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
