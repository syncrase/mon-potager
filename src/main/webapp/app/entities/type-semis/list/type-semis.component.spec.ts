...
describe('TypeSemis Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'type-semis', component: TypeSemisComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.typeSemis?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
