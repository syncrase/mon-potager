...
describe('Url Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'url', component: UrlComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.urls?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
