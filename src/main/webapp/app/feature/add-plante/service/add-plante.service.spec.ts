...
import {AddPlanteService} from "./add-plante.service";


describe('Plante Service', () => {
  let service: AddPlanteService;
  ...
  beforeEach(() => {
    ...
    expectedResult = null;
    service = TestBed.inject(AddPlanteService);
  ...
  describe('Service methods', () => {
    ...
    describe('addPlanteToCollectionIfMissing', () => {
      ...
      it('should add only unique Plante to an array', () => {
        const planteArray: IPlante[] = [{ id: 123 }, { id: 456 }, { id: 66347 }];
