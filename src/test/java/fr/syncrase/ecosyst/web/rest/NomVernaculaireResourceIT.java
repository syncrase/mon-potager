...
class NomVernaculaireResourceIT {
    ...
    public static NomVernaculaire createEntity(EntityManager em) {
        ...
        nomVernaculaire.setCronquistRank(cronquistRank);
    ...
    @Test
    @Transactional
    void getAllNomVernaculairesByCronquistRankIsEqualToSomething() throws Exception {
        // Initialize the database
        nomVernaculaireRepository.saveAndFlush(nomVernaculaire);
        CronquistRank cronquistRank;
        if (TestUtil.findAll(em, CronquistRank.class).isEmpty()) {
        ...
        // Get all the nomVernaculaireList where cronquistRank equals to cronquistRankId
        defaultNomVernaculaireShouldBeFound("cronquistRankId.equals=" + cronquistRankId);

        // Get all the nomVernaculaireList where cronquistRank equals to (cronquistRankId + 1)
        defaultNomVernaculaireShouldNotBeFound("cronquistRankId.equals=" + (cronquistRankId + 1));
    }
