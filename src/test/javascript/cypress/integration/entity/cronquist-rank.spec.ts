...
describe('CronquistRank e2e test', () => {
  ...
  beforeEach(() => {
    ...
    cy.intercept('GET', '/api/nom-vernaculaires', {
      statusCode: 200,
  ...
  describe('CronquistRank page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('last delete button click should delete instance of CronquistRank', () => {
  ...
  describe('new CronquistRank page', () => {
    ...
    it.skip('should create an instance of CronquistRank', () => {
      cy.get(`[data-cy="rank"]`).select('SOUSCLASSE');

      cy.get(`[data-cy="noms"]`).select([0]);
